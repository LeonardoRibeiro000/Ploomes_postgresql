...
# Configuração da API
url = "https://api2.ploomes.com/Deals@Status"
...
def insert_new_data(df, table_name):
    ...
    try:
        ...
        # Sanitizar nomes de colunas e substituir NaN por None
        df_filtered.columns = [sanitize_column_name(col) for col in df_filtered.columns]
        df_filtered = df_filtered.where(pd.notnull(df_filtered), None)
        
        # Ajustar precisão de floats
